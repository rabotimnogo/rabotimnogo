# 👋 Привет, я Максим — Data Scientist | ML Engineer

### 📊 Специализация:
- **ML/DL**: Построение и оптимизация моделей машинного обучения.
- **Data Analysis**: Глубокая работа с данными, включая обработку и визуализацию.
- **Fraud Detection**: Разработка систем обнаружения мошенничества (Anomaly Detection, Classification).
